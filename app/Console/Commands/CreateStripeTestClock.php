...
class CreateStripeTestClock extends Command
{
    ...
    public function handle()
    {
        ...
        times as needed (like when removing all test clocks and recreating them).
        Also, I want to make use of custom helpers functions that I saw, like writeNewEnvironmentFileWithClock().
        */
        try {
